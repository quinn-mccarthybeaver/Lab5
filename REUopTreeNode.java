...
public class REUopTreeNode extends RETreeNode{
   ...
   public static void main (String[] aa)throws Exception{
      ...
      RELeafTreeNode 
      x = new RELeafTreeNode('a'),
      y = new RELeafTreeNode('c'),
      z = new RELeafTreeNode('0'),
      w = new RELeafTreeNode('.');
      
      REBopTreeNode
      u = new REBopTreeNode('|', x, y),
      v = new REBopTreeNode('X', z, w),
      s = new REBopTreeNode('|', u, v),
      t = new REBopTreeNode('|', s, x),
      r = new REBopTreeNode('X', z, t);
      
      REUopTreeNode
      a = new REUopTreeNode('?', t),
      b = new REUopTreeNode('+', s),
