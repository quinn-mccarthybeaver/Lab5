...
public class RegularExpressionFactory {
    ...
    private static TreeSet<Character> expStarters,   // (, a-z, 0, .
        postfixOps,                                  // +, ?, *
    ...
    public static String PATTERN_SET_FOR_BASE_LETTERS;
    ...
    private static RETreeNode S() throws Exception {
        ...
        if (!expStarters.contains(lk))
            throw new Exception("invalid char \'" + lk + "\' cannot start an expression");
        else {
            RETreeNode temp = null, subT = A();
            ...
            while (lk == '|') {
                ...
                lk = lookahead();
                if (!expStarters.contains(lk))
                    throw new Exception("invalid char \'" + lk + "\' not in first of A");
                temp = A();
    ...
    public static void main(String[] a) throws Exception {
        ...
        RegularExpression re1 = makeRegularExpression("a|bc(.?)+"),
                          re2 = makeRegularExpression("a"), re3 = makeRegularExpression("0"),
                          re4 = makeRegularExpression("."), re5 = makeRegularExpression("cba"),
                          re6 = makeRegularExpression("a?"), re7 = makeRegularExpression("a+"),
                          re8 = makeRegularExpression("a*"), re9 = makeRegularExpression("a|z"),
                          ...
                          re15 = makeRegularExpression("a"), re16 = makeRegularExpression("0"),
                          re17 = makeRegularExpression("."), re18 = makeRegularExpression("cba"),
                          re19 = makeRegularExpression("ad?"), re20 = makeRegularExpression("aj+"),
                          re21 = makeRegularExpression("ak*"), re22 = makeRegularExpression("a|yz"),
